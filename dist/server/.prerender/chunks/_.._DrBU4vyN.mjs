...
import { a as getAllCategories, b as getArticlesByCategory, c as categoryToSlug } from "./articles_CSfOZ2Bv.mjs";
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "CategoryLayout", $$CategoryLayout, { "tag": tag, "articles": page2.data, "page": page2 })}`;
}, "D:/AI News/dailyaimail/src/pages/category/[category]/[...page].astro", void 0);
const $$file = "D:/AI News/dailyaimail/src/pages/category/[category]/[...page].astro";
const $$url = "/category/[category]/[...page].html";
