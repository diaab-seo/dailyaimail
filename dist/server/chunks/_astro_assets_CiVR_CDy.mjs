...
import { v as typeHandlers, w as types, A as AstroError, N as NoImageMetadata, x as FailedToFetchRemoteImageDimensions, a as isRemoteAllowed, y as RemoteImageNotAllowed, z as joinPaths, E as ExpectedImage, i as isRemotePath, L as LocalImageUsedWrongly, M as MissingImageDimension, B as UnsupportedImageFormat, C as IncompatibleDescriptorOptions, D as UnsupportedImageConversion, G as ExpectedImageOptions, H as ExpectedNotESMImage, J as InvalidImageService, K as ImageMissingAlt, m as maybeRenderHead, c as addAttribute, s as spreadAttributes, b as renderTemplate, O as FontFamilyNotFound, u as unescapeHTML } from "./worker-entry_CFnXz0Lq.mjs";
import { D as DEFAULT_HASH_PROPS, a as DEFAULT_OUTPUT_FORMAT, b as VALID_SUPPORTED_FORMATS } from "./consts_DCUS4NoK.mjs";
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      "./image-service-workerd_BzLaXLGv.mjs"
    ).catch((e) => {
