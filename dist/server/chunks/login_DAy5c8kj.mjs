...
import { l as renderComponent, r as renderTemplate, h as addAttribute, m as maybeRenderHead } from "./worker-entry_DmggEcAh.mjs";
...
const $$Login = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (user) return Astro2.redirect(returnTo);
