...
import { b as getUserByEmail, u as updateLastLogin } from "./db_B2V00Vzv.mjs";
...
Don't have an account? <a href="/auth/register" data-astro-cid-j7y7d5ql>Create one</a> </p> </div> </div> `])), maybeRenderHead(), registered && renderTemplate`<div class="auth-notice auth-notice--success" data-astro-cid-j7y7d5ql>
Account created successfully. You can now sign in.
</div>`, error && renderTemplate`<div class="auth-notice auth-notice--error" data-astro-cid-j7y7d5ql>${error}</div>`, addAttribute(email, "value")) })}`;
