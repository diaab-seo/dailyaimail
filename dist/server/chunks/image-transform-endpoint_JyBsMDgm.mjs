...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      "./image-service-workerd_BGmXBXCz.mjs"
    ).catch((e) => {
...
async function getImage$1(options, imageConfig2) {
  ...
  const matchesValidatedTransform = (transform2) => transform2.width === validatedOptions.width && transform2.height === validatedOptions.height && transform2.format === validatedOptions.format;
...
}, "D:/AI News/dailyaimail/node_modules/astro/components/Image.astro", void 0);
const mimes = {
  "3g2": "video/3gpp2",
  "3gp": "video/3gpp",
  "3gpp": "video/3gpp",
...
}, "D:/AI News/dailyaimail/node_modules/astro/components/Picture.astro", void 0);
...
}, "D:/AI News/dailyaimail/node_modules/astro/components/Font.astro", void 0);
const assetQueryParams = void 0;
const imageConfig = { "endpoint": { "route": "/_image", "entrypoint": "@astrojs/cloudflare/image-transform-endpoint" }, "service": { "entrypoint": "@astrojs/cloudflare/image-service-workerd", "config": {} }, "domains": [], "remotePatterns": [], "responsiveStyles": false };
...
const page = () => _page;
const imageTransformEndpoint___js = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  page
}, Symbol.toStringTag, { value: "Module" }));
export {
  baseService as b,
  imageTransformEndpoint___js as i
};
