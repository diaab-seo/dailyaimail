...
This is the second significant information leak from Anthropic in the span of a week — following the [Claude Code source map exposure](https://dailyaimail.news/news/claude-code-source-code-leak-npm-source-map) that exposed 1,906 proprietary TypeScript files on npm the same day. Both incidents stem from configuration defaults rather than external attacks: in each case, a system set to public by default when it should have been private.
