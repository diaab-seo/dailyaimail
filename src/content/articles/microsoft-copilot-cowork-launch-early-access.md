...
image: /images/microsoft-copilot-cowork-launch-early-access.png
imageWidth: 1200
imageHeight: 675
imageCaption: >-
  Microsoft's Copilot Cowork is now in early access via Frontier, bringing
  agentic multi-step task handling and dual-model research verification to
  Microsoft 365.
keywords:
  - Microsoft Copilot Cowork
  - Copilot Researcher Critique
  - Microsoft 365 Wave 3
  - Copilot Model Council
  - Microsoft Anthropic Claude
articleSection:
  - Technology
...
![Copilot Cowork interface showing agentic task planning inside Microsoft 365.](/images/microsoft-copilot-cowork.jpeg)

According to [Microsoft's announcement](https://www.microsoft.com/en-us/microsoft-365/blog/2026/03/30/copilot-cowork-now-available-in-frontier/), Cowork is positioned as the connective tissue between individual Copilot interactions and full enterprise workflow automation — a colleague-like layer that can operate across documents, emails, and workflows without requiring the user to manage each step manually.
...
![The Critique feature pairs OpenAI GPT and Anthropic Claude in a dual-model review pipeline inside Copilot Researcher.](/images/ms365-copilot-researcher-critique.jpeg)

[Reuters reports](https://www.reuters.com/business/microsoft-unveils-ai-upgrades-rolls-out-copilot-cowork-early-access-customers-2026-03-30/) that Microsoft plans to make this relationship bidirectional in future releases — meaning Claude drafts could eventually be reviewed by GPT in return, creating a genuine mutual verification loop rather than a one-directional quality filter. Microsoft says Critique improved Researcher's score by 13.8% on the DRACO benchmark, the industry standard measure for deep research accuracy and quality.
...
Copilot Cowork is available now in early access through Microsoft's [Frontier program](https://www.microsoft.com/en-us/microsoft-365/blog/2026/03/30/copilot-cowork-now-available-in-frontier/) for eligible Microsoft 365 subscribers.